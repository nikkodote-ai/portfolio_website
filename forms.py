...
class StrokeForm(FlaskForm):
    ...
    work_type = SelectField("Work Type", choices = [("govt_job","Governtment Job"),("never_worked", "Never Worked"),("private", "Private"),("self_employed", "Self-employed"), ("children", "Children")], validators = [DataRequired(),])
