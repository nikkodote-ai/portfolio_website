...
from wtforms import StringField, SubmitField, BooleanField, FloatField, IntegerField, SelectField, PasswordField
...
class CreateForm(FlaskForm):
    ...
    type = SelectField("Post Type",
                       choices=[("blog", "Blog"), ("app", "App"), ("other", "External Site URL to be used")])
...
class TTSForm(FlaskForm):
    ppt_file = FileField("Open PPTX File", validators=[DataRequired(), FileRequired(),
                                                       FileAllowed(['pptx', 'pptm', 'ppt'], 'Powerpoint Files only')],
...
class StrokeForm(FlaskForm):
    ...
    work_type = SelectField("Work Type", choices=[("govt_job", "Government Job"), ("never_worked", "Never Worked"),
                                                  ("private", "Private"), ("self_employed", "Self-employed"),
                                                  ("children", "Children")], validators=[DataRequired(), ])
    ...
    smoking_status = SelectField("Smoking Status", choices=[
        ("unknown", "Unknown"), ("formerly_smoked", "Formerly Smoked"), ("never_smoked", "Never Smoked"),
        ("smokes", "Smokes")],
                                 validators=[DataRequired()])
